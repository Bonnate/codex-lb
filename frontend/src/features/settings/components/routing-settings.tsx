        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">요청을 계정들에 어떻게 분배할지 제어합니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="divide-y rounded-lg border">
          <div className="flex items-center justify-between gap-4 p-3">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                스트리밍 응답에 대해 `codex-lb`가 업스트림에 어떻게 연결할지 선택합니다.
              </p>
            </div>
            <Select
          ...
          <div className="flex items-center justify-between gap-4 p-3">
            <div>
              ...
              <p className="text-xs text-muted-foreground">요청을 계정들에 어떻게 분배할지 선택합니다.</p>
            </div>
            <Select
          ...
          <div className="flex items-center justify-between p-3">
            <div>
              <p className="text-sm font-medium">스티키 스레드</p>
          ...
          <div className="flex items-center justify-between p-3">
            <div>
              ...
              <p className="text-xs text-muted-foreground">쿼터가 더 빨리 초기화되는 계정으로 트래픽을 더 보냅니다.</p>
            </div>
            <Switch
