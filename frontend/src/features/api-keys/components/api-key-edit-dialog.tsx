            ...
            <div className="space-y-1">
              ...
              <Select value={enforcedReasoningEffort} onValueChange={setEnforcedReasoningEffort}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="minimal">매우 낮음</SelectItem>
            ...
            <div className="space-y-1">
              ...
              <Select value={enforcedServiceTier} onValueChange={setEnforcedServiceTier}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="flex">유연</SelectItem>
                </SelectContent>
              </Select>
            </div>
...
function LimitUsageBar({ limit }: { limit: ApiKey["limits"][number] }) {
  ...
  const modelLabel = limit.modelFilter || "전체";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription>제한과 라이프사이클 설정을 수정합니다.</DialogDescription>
        </DialogHeader>
